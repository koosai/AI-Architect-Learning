...
- [Incentives Build Robustness in BitTorrent (Bram Cohen, 2003)](https://bittorrent.org/bittorrentecon.pdf) —— tit-for-tat 激励与分块交换的一手论文。
- [BEP 3: The BitTorrent Protocol Specification](https://www.bittorrent.org/beps/bep_0003.html) —— 协议官方规范。
