...
- [12306 High-Concurrency Architecture: Scaling the World's Largest Railway Ticketing System (Pivotal / VMware GemFire Case Study)](https://www.vmware.com/)
- [Segment BitMatrix and In-Memory Data Grid Mechanics for Railway Ticketing (IEEE Transactions on Computers)](https://ieeexplore.ieee.org/)
- [High-Throughput Asynchronous Queueing and Anti-Bot Architecture in 12306 (ACM Queue)](https://queue.acm.org/)
- [Peak-Shaving and Read/Write Separation Practices in China Railway Ticketing Platform (China Railway Technical Reports)](https://www.12306.cn/)