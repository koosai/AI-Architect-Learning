...
<ResearchNote
  title="检索增强问答的产品化:可溯源即信任"
  source="Perplexity Blog"
  href="https://www.perplexity.ai/blog"
  insight="Perplexity 把「搜索编排 + 重排 + 带引用生成」做成产品:实时抓取、按相关度重排、让答案每句都挂可点击的来源,把 RAG 的可溯源变成用户可见的信任。"
  application="架构启示:RAG 产品的差异化不在模型,在检索质量与「引用可核验」——把证据显式呈现,是对抗幻觉、建立信任的产品级手段。"
/>
