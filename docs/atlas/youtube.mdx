...
<ResearchNote
  title="召回 + 排序:大规模推荐的通用漏斗"
  source="Covington et al. (2016), Deep Neural Networks for YouTube Recommendations (RecSys)"
  href="https://research.google/pubs/pub45530/"
  insight="YouTube 推荐用两阶段——候选生成把百万视频缩到数百、再精排到几十;并从「点击」目标转向「观看时长」目标以对抗标题党。"
  application="架构启示:大规模推荐的通用骨架是「召回 + 排序」两阶段漏斗;优化目标的选择(时长 vs 点击)直接塑造内容生态。"
/>
