...
- [Volcano: A Cloud-Native Batch Scheduling System for High-Performance AI Workloads (CNCF Documentation)](https://volcano.sh/)
- [Slurm Workload Manager Architecture: HPC Batch Scheduling and Resource Allocation (SchedMD Technical Papers)](https://slurm.schedmd.com/)
- [Topology-Aware GPU Scheduling in Large-Scale AI Clusters (IEEE/ACM Transactions on Networking)](https://ieeexplore.ieee.org/)
- [Gang Scheduling and De-fragmentation Mechanics in 10,000-GPU Training Fabrics (ACM SIGCOMM)](https://dl.acm.org/)