...
<CompareSlider
  before={{
    title: '传统 TLS + Protobuf/HTTP 架构',
    description: '每次连接需 2-3 RTT 握手，序列化包头带有类型描述，多 DC 用户寻址依赖层层 HTTP 代理。'
  }}
  after={{
    title: 'MTProto 2.0 + TL + 自研 C++ 架构',
    description: '0-1 RTT 极速会话恢复，TL 二进制零内存分配解析，直连主 DC 骨干网，吞吐量提升 10 倍。'
  }}
/>
