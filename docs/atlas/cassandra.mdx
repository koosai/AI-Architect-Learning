...
<ResearchNote
  title="从 Dynamo 到 Cassandra:无主复制的可用性哲学"
  source="DeCandia et al. (2007), Dynamo: Amazon Highly Available Key-value Store (SOSP)"
  href="https://dl.acm.org/doi/10.1145/1294261.1294281"
  insight="Cassandra 继承 Dynamo 的无主复制 + 一致性哈希 + 可调 Quorum(R+W>N),用最终一致性换来无单点、跨机房线性扩展与可用性优先。"
  application="架构启示:当可用性与分区容忍比强一致更重要(购物车、feed),无主 + 读修复/提示移交比主从更抗故障。"
/>
