...
<ResearchNote
  title="借壳 Discord:把工程重心集中到推理"
  source="Midjourney Documentation"
  href="https://docs.midjourney.com/"
  insight="Midjourney 把扩散模型推理做成服务,用 Discord 作前端——省掉自建 UI、账号与支付,用现成社区平台承载队列、交互与分发,极速冷启动一个产品。"
  application="架构启示:MVP 阶段「借壳」成熟平台当前端,是把工程重心集中到核心(推理)、快速验证市场的务实取舍。"
/>
