...
<ResearchNote
  title="图状态机:给 Agent 编排加上 checkpoint"
  source="LangGraph Documentation"
  href="https://langchain-ai.github.io/langgraph/"
  insight="LangGraph 把 Agent 编排建成带条件边的图状态机,节点是步骤、边是转移,并支持 checkpoint 与 human-in-the-loop——让多步 Agent 的状态可持久、可回溯、可插入人工。"
  application="架构启示:复杂 Agent 流程用「显式状态图」比「隐式提示链」更可控——可暂停、可恢复、可审计,是生产级 Agent 的骨架。"
/>
