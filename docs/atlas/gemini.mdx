...
<ResearchNote
  title="原生多模态:训练时就统一 token 空间"
  source="Gemini Team (2024), Gemini 1.5 (arXiv:2403.05530)"
  href="https://arxiv.org/abs/2403.05530"
  insight="Gemini 1.5 用 MoE + 原生多模态把上下文推到百万 token 级,靠的是训练即多模态对齐与高效长上下文注意力,而非事后拼接各模态。"
  application="架构启示:原生多模态(训练时统一表示)比「各模态各模型再融合」更能跨模态推理——架构决定能力上限。"
/>
