...
$$\text{NextTarget} = \text{CurrentTarget} \times \frac{\text{ActualTimeFor2016Blocks}}{14 \text{ Days}}$$
...
<CompareSlider
  before={{
    title: '早期纯 1MB 基础区块 + ECDSA 签名',
    description: '签名与交易体混在一起，每秒仅处理 7 笔交易，多重签名脚本极其臃肿费手续费。'
  }}
  after={{
    title: 'SegWit + Taproot + Lightning Network Layer-2',
    description: '签名隔离降低体积，Schnorr 聚合多重签名，闪电网络实现百万级 TPS 秒级小额支付。'
  }}
/>
